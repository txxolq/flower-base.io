...
<body bgcolor="#bbdcff">
    ...
    <div class="slide1">
        <div class="menu">
            <a class="menu-item" href=""><strong>Корзина</strong></a>
        ...
        <div class="menu2">
            ...
            <a class="menu-item2" href="index.php"><strong>выход</strong></a>
        </div>
        ...
        <div class="adm"> 
          <a href="www.php"><strong> <img src="чел.png" alt="" max-width="100%" width="6%"> </strong></a> 
        </div>
